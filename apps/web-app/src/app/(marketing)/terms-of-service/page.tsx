      ...
      <div className="relative mx-auto mt-32 max-w-[80rem] px-6 text-center md:px-8">
        ...
        <section className="container mt-24 flex max-w-5xl flex-col gap-8 text-left px-4">
          ...
          <p>
            ...
            fees for access to and use of the ChickenNugget Platform.
          </p>
          <p>
            <strong>C. “ChickenNugget API”</strong> means ChickenNugget’s
            proprietary toolkit, including any application programming interface
            that ChickenNugget makes available, together with associated source
            code, tools, and other materials, that allows building, deploying,
            managing and training generative AI projects, available through the
            Site or through other channels as determined by ChickenNugget (e.g.
            ChickenNugget’s developer hub).
          </p>
          <p>
            <strong>D. “ChickenNugget Platform”</strong> means ChickenNugget’s
          ...
          <p>
            ...
            (3) becomes public through no fault of Recipient. ChickenNugget’s
            ...
            the ChickenNugget Platform. Customer’s Confidential Information
            includes the Customer Data.
          </p>
          <p>
            <strong>F. “Customer Data”</strong> means all non-public data and
            content uploaded by Customer or an Authorized User to the
            ChickenNugget Platform or made available to ChickenNugget by or on
            behalf of Customer in the course of providing the Services.
            “Customer Data” does not include Usage Data.
          </p>
          <p>
            <strong>G. “Documentation”</strong> means user documentation, in all
            forms, relating to the ChickenNugget Platform made available by
            ChickenNugget (e.g., user manuals and online help files).
          </p>
          <p>
          ...
          <p>
            ...
            entered into between Customer and ChickenNugget (including any
          ...
          <p>
            ...
            Customer’s use of the ChickenNugget Platform specified in an Order,
            including number of Authorized Users and Customer Property Users.
          </p>
          <p>
            <strong>L. “Services”</strong> means ChickenNugget’s provision of
            the ChickenNugget Platform, Support Services, and any other services
            described in the applicable Order.
          </p>
          <p>
            <strong>M. “Usage Data”</strong> means data relating to use of the
            ChickenNugget Platform or any Authorized User’s use of any of the
          ...
          <h4>2. Services.</h4>
          <p>
            <strong>A. Access to the ChickenNugget Platform.</strong> Subject to
            Customer’s payment of all fees and compliance with this Agreement,
            ChickenNugget grants to Customer a worldwide, non-exclusive,
            non-transferable, non-sublicensable right during the Order Term to
            use the ChickenNugget Platform by and through its Authorized Users
            in support of Customer’s business operations and in accordance with
            any Service Limitations and Documentation. ChickenNugget may modify
            or update the ChickenNugget Platform from time to time to keep the
            ChickenNugget Platform current and relevant for its customer base
            generally.
          </p>
          <p>
            <strong>B. Registration.</strong> To use the Services, Customer must
            create and register an account with ChickenNugget. Customer
            represents and warrants that all information provided to
            ChickenNugget in connection with such registration is true,
            accurate, and complete. Except as prohibited by law, ChickenNugget
            may refuse registration or its initial provision of Services for any
            reason or no reason.
          </p>
          <p>
          ...
          <p>
            ...
            all fees and compliance with this Agreement, ChickenNugget grants to
            Customer a worldwide, non-exclusive, non-transferable,
            non-sublicensable right during the Order Term to (1) send calls to
            and receive calls from the ChickenNugget API in solely in connection
            with Customer’s authorized use of the Services functionality set
            forth in an Order, (2) internally reproduce and modify the
            ChickenNugget API to enable Customer to develop an integration
            between Customer’s internal systems and the ChickenNugget Platform,
            in each case, solely as described in the Documentation.
          </p>
          <p>
            <strong>E. Support Services.</strong> Subject to Customer’s payment
            of all Fees and compliance with this Agreement, ChickenNugget will
            provide support relating to usage of the Services via email and the
            support functions within the ChickenNugget Platform, or as otherwise
            described in the applicable Order (the “Support Services”).
          </p>
          <p>
            <strong>F. Subcontractors.</strong> ChickenNugget may use
            subcontractors (including with respect to the processing of
            information) or other third parties to perform its obligations under
            this Agreement, but ChickenNugget will remain responsible for all
            such obligations.
          </p>
          ...
          <p>
            ...
            parties to use ChickenNugget Platform or Documentation; (2) use the
            ChickenNugget Platform, or Documentation to provide services to
            third parties (e.g., as a service bureau); (3) use the ChickenNugget
            Platform in violation of the Service Limitations or this Agreement;
            (4) circumvent or disable any security or other technological
            features or measures of the ChickenNugget Platform; (5) reverse
            engineer, decompile, disassemble, or otherwise attempt to discover
            the source code, object code, or underlying structure, ideas,
            know-how, or algorithms relevant to the ChickenNugget Platform; (6)
            modify, translate, or create derivative works based on the
            ChickenNugget Platform, or Documentation; (7) remove any proprietary
            notices or labels from the ChickenNugget Platform or Documentation;
            (8) use the ChickenNugget Platform in a manner that violates or
            attempts to circumvent Applicable Law; (9) use the ChickenNugget
            Platform to distribute any viruses or other malicious code, or to
            transmit large amounts of data in a way that would be expected to
            have a detrimental effect on the ChickenNugget Platform; or (10)
            access the ChickenNugget Platform to develop a competing product or
            service.
          </p>
          <p>
            ...
            or permit to use, deploy, or otherwise benefit from the
            ChickenNugget Platform (“Downstream Entities”); in each case, as if
            such action or inaction were an action or inaction of Customer. As
            part of the registration process, Customer will identify an
            administrative username and password for Customer’s ChickenNugget
            Platform account. Customer represents and warrants that all
            registration information Customer provides is truthful, accurate,
            and complete, and that Customer will maintain the accuracy of such
            information. Customer is responsible for maintaining control over
            Customer’s account, including the confidentiality of Customer’s
            username and password, and is responsible for all activities that
            occur on or through Customer’s account and all Authorized Users’
          ...
          <p>
            ...
            integrations made available by ChickenNugget, are licensed from
            third parties and are subject to terms and conditions provided by
            such third parties, including open-source or private models,
            algorithms, and systems ("Third-Party Software"). Each component of
            Third-Party Software is licensed under the terms of the license that
            accompanies such Third-Party Software, which may include open-source
            licenses. Nothing in this Agreement limits Company’s rights under,
            or grants Company rights that supersede rights available in, the
            terms and conditions of any applicable license for the Third-Party
            Software. Third-Party Software may be subject to separate license
            agreements or restrictions on use ("Third-Party Restrictions"), and
            Company agrees to comply with all such Third-Party Restrictions.
            THIRD-PARTY SOFTWARE IS PROVIDED BY THIRD PARTIES, NOT SEAWATTS.
            SEAWATTS DOES NOT WARRANT, SUPPORT, OR ACCEPT RESPONSIBILITY OF ANY
            KIND FOR THIRD-PARTY SOFTWARE.
          </p>
          <p>
            <strong>D. Optional Third-Party Services.</strong> ChickenNugget and
            ...
            operation, ChickenNugget does not warrant or provide support for
            Third-Party Services. ChickenNugget is not responsible for any
            violations of Applicable Law by Third-Party Service providers, or
            for any liability arising from Company’s use thereof. ChickenNugget
            does not guarantee the continued availability of any Third-Party
            Services (or any integration with Third-Party Services or related
            Service features), and if such Third-Party Services or related
            features are discontinued, Company will not be entitled to any
            refund, credit, or other compensation. Depending on Company’s
            location, certain Third-Party Services may not be available.
          </p>
          ...
          <p>
            ...
            ChickenNugget Platform (“Input”), and receive output generated and
            ...
            subject to Company’s compliance with this Agreement, ChickenNugget
            hereby assigns to Company all its right, title and interest in and
            to Output; provided, ChickenNugget may use Content to provide,
            improve and maintain the Services, including sharing with
            Third-Party Software providers, comply with Applicable Law, and
          ...
          <p>
            ...
            subject to any obligation of ChickenNugget, whether of
            confidentiality, attribution, or otherwise, and ChickenNugget is not
            liable for any use or disclosure of any Input. ChickenNugget may
            (but is not obligated to) remove or alter any Input at any time for
            any reason. Except as expressly stated herein (including Section
            4.B), ChickenNugget neither endorses nor is responsible for any
            Input.
          </p>
          <p>
            ...
            rights in the Customer Data are transferred to ChickenNugget by this
            Agreement. ChickenNugget does not have any rights to the Customer
            Data except for the limited express rights granted in this
            Agreement. Customer hereby grants ChickenNugget a worldwide,
            perpetual, non-exclusive, irrevocable, royalty-free, fully paid,
            sublicensable (to ChickenNugget’s third-party service providers)
            license to host, store, transfer, display, perform, reproduce,
            modify, create derivative works of, and distribute Customer Data, in
            whole or in part, in any media or distribution methods now known or
            later developed, solely during the Term and as necessary for
            ChickenNugget to provide the Services to Customer and in accordance
            with the settings on Customer’s account and the features of the
            Services Customer elects to utilize.
          </p>
          <p>
            <strong>C. ChickenNugget IP.</strong> ChickenNugget and its
            licensors own the ChickenNugget Platform, Documentation, and Usage
            Data, including all Intellectual Property Rights therein (the
            “ChickenNugget IP”). No ownership rights in the ChickenNugget IP are
            transferred to Customer by this Agreement. Customer does not have
            any rights in or to the ChickenNugget IP except for the limited
            express rights granted in this Agreement.
          </p>
          <p>
            <strong>D. Feedback.</strong> If Customer gives ChickenNugget
            feedback, comments, or suggestions concerning the Services
            (collectively, “Feedback”), Customer hereby assigns to ChickenNugget
            all right, title, and interest in and to the Feedback, and
            ChickenNugget is free to use the Feedback without payment,
            attribution, or restriction.
          </p>
          <p>
            <strong>E. Usage Data.</strong> ChickenNugget may collect and
            analyze Usage Data and other information relating to the provision,
            use, and performance of various aspects of the ChickenNugget
            Platform and related systems and technologies (including information
            provided by third-party analytical tools). ChickenNugget may use
            Usage Data for any purpose, including to improve the Services and
          ...
          <p>
            Customer will pay ChickenNugget all fees for the use of the Services
            ...
            ChickenNugget all fees associated with ChickenNugget’s then-current
            plan pricing allowing for such number of monthly users. If in any
            month Customer exceeds the monthly users permitted under any
            standard ChickenNugget subscription plan, ChickenNugget may (without
            limiting any other available remedy to ChickenNugget) restrict
            Customer’s usage to the maximum monthly users (or any greater
            amount, in ChickenNugget’s sole discretion) permitted under a
            standard subscription plan. ChickenNugget may change the Fees or
            applicable charges or institute new charges and Fees at the end of
            the initial Order Term or then-current renewal Order Term, upon 30
            days’ prior notice to Customer (which may be sent by email). If
            Customer believes that ChickenNugget has billed Customer
            incorrectly, Customer must contact ChickenNugget no later than 30
            days after the closing date on the first billing statement in which
            the error or problem appeared, to receive an adjustment or credit.
            All Fees are non-refundable, except as otherwise specified in this
            Agreement.
          </p>
          <p>
            ChickenNugget, in its sole discretion and at any time, may modify
            Fees; provided, any Fee change will become effective after the end
            of the then-current billing cycle. ChickenNugget will provide
            Company with reasonable prior notice of any such change and allow
            Company to terminate this Agreement or any affected Order before
            such change becomes effective. Company’s continued use of Services
            after a Fee change comes into effect constitutes Company’s agreement
            to pay the modified Fee amount.
          </p>
          <p>
            ...
            access to the ChickenNugget Platform. Customer will pay all Fees in
            U.S. Dollars.
          </p>
          <p>
            <strong>B. Payment Processing.</strong> ChickenNugget may require
            payment by credit card, debit card, or other payment instruments
            which are processed and billed by ChickenNugget’s third-party
            payment processors (“Payment Processor”). Customer hereby authorizes
            ChickenNugget’s Payment Processors to bill Customer’s payment
            instrument on file with ChickenNugget (or provided by or on behalf
            of Customer to ChickenNugget or a Payment Processor in connection
            with any invoice or charge) in accordance with each Order. Such
            billing may include advance payment on a periodic basis and ad hoc
            charges for usage Fees and other one-time payments. ChickenNugget
            will provide Customer with, or otherwise make available to Customer,
            a receipt for each such charge. If ChickenNugget’s Payment Processor
            is Stripe Inc. (“Stripe”), the processing of credit card charges or
            credits through Stripe, as applicable, relating to use of the
            Service is subject to the Stripe Connected Account Agreement
            ...
            ChickenNugget and its Payment Processors with current, accurate, and
          ...
          <p>
            ...
            taxes imposed on ChickenNugget, Customer will bear all taxes,
            duties, and other governmental charges relating to the Services.
          </p>
          ...
          <p>
            ...
            ChickenNugget may terminate or suspend this Agreement or any part of
            it immediately upon written notice to Customer without a cure period
            if Customer breaches Section 3.A or any of the terms of this
            Agreement relating to ChickenNugget’s Intellectual Property Rights
            or ChickenNugget’s Confidential Information. ChickenNugget may
            terminate this Agreement, effective immediately upon written notice,
            if Customer files, or has filed against it, a petition for voluntary
            or involuntary bankruptcy or pursuant to any other insolvency law,
          ...
          <p>
            ...
            granted by ChickenNugget to Customer under this Agreement or the
          ...
          <p>
            ...
            expiration or termination of this Agreement, ChickenNugget will make
            all Customer Data then held by ChickenNugget available to Customer
            for electronic retrieval for a period of 30 days. After such period,
            ChickenNugget will delete any stored Customer Data. Upon expiration
            or termination of this Agreement for any reason: (1) ChickenNugget
            will not refund Customer any Fees paid in advance of such expiration
            or termination; and (2) within ten days after such expiration or
            termination, Customer will pay ChickenNugget all remaining usage
            Fees owed under any terminated Order. The following sections of this
          ...
          <p>
            <strong>B. ChickenNugget Warranty.</strong> ChickenNugget represents
            and warrants to Customer that: (1) ChickenNugget will perform the
            Services in a good and workmanlike manner; and (2) ChickenNugget has
            the necessary rights to authorize Customer to use the ChickenNugget
            Platform in accordance with this Agreement.
          </p>
          <p>
            <strong>C. Customer Warranty.</strong> Customer represents and
            warrants to ChickenNugget that it: (1) has the rights and consents
            necessary and appropriate to authorize and permit ChickenNugget to
            use all data and information provided or made available to it by or
            on behalf of Customer (including all Input) in accordance with this
            Agreement, and such use by ChickenNugget of Input will not infringe
            or violate any third-party (including any Authorized User) right,
            including any Intellectual Property Right or privacy right; (2) will
            use the ChickenNugget Platform in compliance with the Documentation
            and Applicable Law; (3) will provide and maintain accurate, current
            and complete information required to enable Authorized Users to
            register for and use the ChickenNugget Platform; and (4) unless
            Company has received sufficient prior written authorization, Input
            does not contain any confidential information of any third party.
          </p>
          <p>
            <strong>D. Combinations.</strong> ChickenNugget will have no
            obligation for any infringement of Intellectual Property Rights
            relating to Customer’s use of the ChickenNugget Platform to the
            extent arising out of: (1) use of ChickenNugget Platform in
            combination with other products or services not recommended or
            provided by ChickenNugget; (2) designs, requirements, or
            specifications required by or provided by Customer; (3) use of the
            ChickenNugget Platform in breach of this Agreement or outside the
            scope of the license granted to Customer; (4) Customer’s failure to
            use ChickenNugget Platform in accordance with the Documentation; or
            (5) any modification of the ChickenNugget Platform not made or
            authorized in writing by ChickenNugget.
          </p>
          <p>
            <strong>E. Disclaimer.</strong> Except for the limited warranties
            described in this Section 8 (Warranties and Disclaimer),
            ChickenNugget makes no other express or implied warranties with
            respect to the ChickenNugget Platform, Documentation, Services, or
            otherwise, and specifically disclaims all implied and statutory
            warranties, including the implied warranties of non-infringement of
            third-party rights, merchantability, satisfactory quality, accuracy,
            ...
            the limited warranties described in this Section 8, the
            ChickenNugget Platform, Documentation, and Services are provided “as
            is.” ChickenNugget does not warrant that the ChickenNugget Platform,
            Documentation, or Services will satisfy Customer’s requirements, are
            without defect or error, or that the operation of the ChickenNugget
            Platform will be uninterrupted. ChickenNugget makes no warranties of
            any kind with respect to any Third Party Software. Some
            jurisdictions do not allow the exclusion or limitation of
            warranties, so that limitation or exclusion may not apply to
            Customer.
          </p>
          <p>
            <strong>
              F. ChickenNugget may make features of the ChickenNugget Platform
              classified as “alpha” or “beta” available to Customer (“Beta
              Features”). ChickenNugget makes no representations that any Beta
              Features will be made generally available and ChickenNugget may
          ...
          <p>
            <strong>A. Defense.</strong> At ChickenNugget’s option and request,
            Customer will defend ChickenNugget and its officers, directors,
            employees, agents, service providers, licensors, and affiliates
            (collectively, the “ChickenNugget Indemnified Parties”) from any
            actual or threatened third-party claim, proceeding, suit, action, or
            ...
            Disclaimer) (a “Customer Indemnifiable Claim”). If ChickenNugget
            requests Customer to defend it from any Customer Indemnifiable
            Claim, ChickenNugget will: (1) give Customer prompt written notice
            of the Customer Indemnifiable Claim; (2) grant Customer full and
            ...
            liability of ChickenNugget without ChickenNugget’s prior written
            consent. ChickenNugget may participate in the defense of a Customer
            Indemnifiable Claim at its own expense and with counsel of its own
            choosing.
          </p>
          <p>
            <strong>B. Indemnification.</strong> Customer will indemnify the
            ChickenNugget Indemnified Parties from and pay: (1) all damages,
            costs, fines, judgements, expenses, and attorneys’ fees reasonably
            incurred by ChickenNugget Indemnified Parties in any Customer
            Indemnifiable Claim); and (2) all amounts that Customer agrees to
            pay to any third party to settle any Customer Indemnifiable Claim.
          </p>
          <p>
            <strong>C. IP Infringement.</strong> If the ChickenNugget Platform
            is held to infringe (or if ChickenNugget reasonably believes will be
            held to infringe) any third-party Intellectual Property Rights,
            ChickenNugget may, at its option and expense: (1) modify the
            ChickenNugget Platform to make it non-infringing; or (2) obtain a
            license that permits Customer to continue using the ChickenNugget
            Platform. If ChickenNugget does not believe either option is
            reasonably practicable, ChickenNugget may terminate this Agreement.
            This Section 9 states ChickenNugget’s sole and exclusive liability,
            and Customer’s sole and exclusive remedy, for the actual or alleged
            infringement of any third-party Intellectual Property Rights arising
            from Customer’s use of the ChickenNugget Platform.
          </p>

          <h4>10. Limitations of Liability.</h4>
          <p>
            <strong>A. Exclusion of Damages.</strong> ChickenNugget will not be
            ...
            including lost profits or loss of business, even if ChickenNugget is
            apprised of the likelihood of such damages occurring.
          </p>
          <p>
            <strong>B. Damages Cap.</strong> ChickenNugget’s total liability of
            all kinds arising out of or related to this Agreement (including
            ...
            not exceed the total amount paid by Customer to ChickenNugget under
            this Agreement during the 12 months immediately proceeding the
            claim, less any liabilities previously incurred by ChickenNugget.
          </p>
          <p>
          ...
          <p>
            <strong>A. Publicity.</strong> ChickenNugget may publicly list
            Customer as a customer of ChickenNugget and use Customer’s
            trademark, trade name, and logo for marketing or promotional
            purposes and in other communications with existing or potential
            ChickenNugget customers, resellers, or investors.
          </p>
          <p>
          ...
          <p>
            ...
            Agreement or delegate its performance without ChickenNugget’s prior
            written consent, and any attempt to do so is void. ChickenNugget may
          ...
          <p>
            ...
            Customer will be void and have no binding effect on ChickenNugget.
            No usage of trade or other regular practice or method of dealing
          ...
          <p>
            ...
            accordance with this Section 12.M. All notices to ChickenNugget will
            be sent to:
          </p>
          <p>SEAWATTS, LLC.</p>
          ...
          <p>Attn: Legal</p>
          <p>
            <strong>N. Force Majeure.</strong> ChickenNugget will not be liable
            for any delay or failure to perform under this Agreement as a result
            of any cause or condition beyond ChickenNugget’s reasonable control
            (a “Force Majeure Event”), so long as ChickenNugget uses reasonable
            efforts to avoid or remove those causes of delay or non-performance.
            If a Force Majeure Event causes ChickenNugget to delay or fail to
            perform its obligations under this Agreement for 30 consecutive
            days, either party may terminate this Agreement.
          </p>
          <p>
            <strong>O. Interpretation.</strong> If ChickenNugget provides a
