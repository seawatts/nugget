      ...
      <Card className="p-5 mb-4">
              ...
              <defs>
                <linearGradient id="sleepGradient" x1="0" x2="0" y1="0" y2="1">
                  <stop
                    ...
                    stopOpacity={0.3}
                  />
                  <stop offset="95%" stopColor="var(--sleep)" stopOpacity={0} />
                </linearGradient>
              </defs>
        ...
        <div className="flex items-center gap-2 mt-4 p-3 bg-muted rounded-lg">
          ...
          <span className="text-sm text-foreground">
            <span className="font-semibold">+8%</span> more sleep than last week
          </span>
        </div>
      </Card>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xl font-bold text-foreground">6h 45m</div>
            </div>
