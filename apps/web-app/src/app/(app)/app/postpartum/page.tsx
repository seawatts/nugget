            ...
            <Card className="p-6 bg-gradient-to-br from-primary/20 to-accent/20 border-primary/30">
              ...
              <div className="grid grid-cols-2 gap-4">
                {recoveryMetrics.map((metric) => (
                  <div className="bg-card/50 rounded-lg p-4" key={metric.label}>
        ...
        {activeTab === 'breastfeeding' && (
          <div className="space-y-4">
            ...
            <Card className="p-6 bg-gradient-to-br from-primary/20 to-accent/20 border-primary/30">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Consider reaching out to a lactation consultant for personalized
                support.
              </p>
        ...
        {activeTab === 'warning' && (
          <div className="space-y-4">
            <Card className="p-6 bg-destructive/20 border-destructive/30">
              ...
              <p className="text-sm text-muted-foreground">
                If you experience any of these symptoms, contact your healthcare
            ...
            <Card className="p-6 bg-gradient-to-br from-primary/20 to-accent/20 border-primary/30">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-foreground">PSI Helpline</span>
                  <Button size="sm" variant="outline">
                    1-800-944-4773
                  </Button>
                </div>
