                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground text-balance">
                        ...
                        healthy weight, and avoid smoking and excessive alcohol
                ...
                <Card className="p-4 border-accent/50">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground text-balance">
                        Start taking prenatal vitamins with folic acid at least
                        3 months before trying to conceive to support early
                        fetal development.
                      </p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-destructive mt-1">•</span>
                      <span>
                        Known fertility issues or previous pregnancy
                        complications
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
