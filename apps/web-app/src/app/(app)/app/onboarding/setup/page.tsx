...
export default function OnboardingSetupPage() {
  ...
  useEffect(() => {
    // Load onboarding data to determine journey stage
    ...
    // Check which tasks are completed by looking at localStorage
    ...
    const hasCaregiver = caregiverData && JSON.parse(caregiverData).babyName;

    const setupTasks: SetupTask[] = [
      {
        completed: false, // Always show as incomplete to encourage completion
