      ...
      <main className="px-4 pt-6 pb-8">
        ...
        <Card className="p-6 mb-6 bg-gradient-to-br from-primary/20 to-accent/20 border-primary/30">
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            Riley had a great day! Sleep patterns are improving with 3 solid
            naps totaling 4.5 hours. Feeding is consistent every 2-3 hours.
            Consider moving bedtime 15 minutes earlier based on recent wake-up
            times.
          </p>
        ...
        <div className="space-y-4 mb-6">
          ...
          <Card className="p-5 border-l-4 border-l-feeding">
            ...
            <p className="text-sm text-foreground/80 mb-3">
              ...
              for their age. Peak feeding times are 7am, 10am, 1pm, 4pm, and
              7pm.
            </p>
            <div className="flex gap-2">
              <Badge className="text-xs" variant="secondary">
          ...
          <Card className="p-5 border-l-4 border-l-accent">
            ...
            <p className="text-sm text-foreground/80 mb-3">
              ...
              regression and increased appetite. Consider scheduling
              pediatrician visit.
            </p>
            <div className="flex gap-2">
              <Badge className="text-xs" variant="secondary">
          ...
          <Card className="p-5 border-l-4 border-l-diaper">
            ...
            <p className="text-sm text-foreground/80 mb-3">
              Current wake windows are slightly long (2.5 hours). Try reducing
              to 2 hours between naps to prevent overtiredness and improve nap
              quality.
            </p>
            <div className="flex gap-2">
              <Badge className="text-xs" variant="secondary">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  ...
                  10-11pm might help extend the first stretch of nighttime
                  sleep.
                </p>
          ...
          <Card className="p-5 bg-muted/50">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  Creating a consistent 20-30 minute bedtime routine can signal
                  to Riley that it's time to sleep and improve sleep quality.
                </p>
                <Button size="sm" variant="outline">
                  View Routine Ideas
                </Button>
