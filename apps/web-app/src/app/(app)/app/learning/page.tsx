  ...
  const courses = [
    {
      color: 'primary',
      description:
        'Comprehensive newborn care guide from first hour through first month - golden hour, reflexes, feeding, sleep, development',
      duration: '90 min',
      icon: Baby,
      lessons: 15,
      modules: 4,
      progress: 40,
      title: 'Newborn Survival Guide',
    },
    {
      color: 'secondary',
      description:
        'Evidence-based breastfeeding course covering physiology, challenges, pumping, and extended nursing',
      duration: '60 min',
      icon: Milk,
      lessons: 12,
      progress: 0,
    ...
    },
    {
      color: 'accent',
      description:
        'AAP guidelines for safe sleep - SIDS prevention, sleep environment, training methods, age-appropriate expectations',
      duration: '50 min',
      icon: Moon,
      lessons: 10,
      progress: 30,
    ...
    },
    {
      color: 'primary',
      description:
        'Age-appropriate activities to support development from newborn through 12 months',
      duration: '45 min',
      icon: TrendingUp,
      lessons: 10,
      progress: 0,
    ...
    {
      color: 'secondary',
      description: 'Step-by-step bathing guide for newborns',
      duration: '15 min',
      icon: Bath,
      lessons: 3,
      progress: 0,
  ...
  const guides = [
    {
      ...
      topics: [
        ...
        { duration: '4 min read', title: 'Paced Bottle Feeding' },
        { duration: '6 min read', title: 'Pumping Schedule & Power Pumping' },
        { duration: '8 min read', title: 'Baby-Led Weaning vs Purees' },
        { duration: '5 min read', title: 'Cluster Feeding Explained' },
        { duration: '4 min read', title: 'Reading Hunger Cues' },
        {
          duration: '7 min read',
          title: 'Formula Feeding Guide (CDC Guidelines)',
        },
        { duration: '6 min read', title: 'Combination Feeding Strategies' },
        { duration: '5 min read', title: 'Feeding Red Flags' },
        { duration: '6 min read', title: 'Understanding Growth Charts (WHO)' },
        { duration: '4 min read', title: 'Vitamin D & Iron (AAP Guidelines)' },
        { duration: '7 min read', title: 'Introducing Allergens (LEAP Study)' },
      ],
    },
    {
      category: 'Sleep',
      ...
      topics: [
        {
          duration: '6 min read',
          title: 'Newborn Sleep Cycles (REM vs Non-REM)',
        },
        {
          duration: '5 min read',
          title: 'Creating an Optimal Bedtime Routine',
        },
        {
          duration: '10 min read',
          title: 'Sleep Training Methods (CIO, Ferber, Gentle)',
        },
        {
          duration: '7 min read',
          title: 'Resettling Techniques for Night Wakings',
        },
        {
          duration: '5 min read',
          title: 'Understanding 45-Minute Sleep Cycles',
        },
        {
          duration: '6 min read',
          title: 'Safe Sleep Checklist (AAP Guidelines)',
        },
        {
          duration: '8 min read',
          title: 'Sleep Regressions (4, 8, 12 Months)',
        },
        { duration: '5 min read', title: 'Age-Appropriate Nap Schedules' },
        { duration: '4 min read', title: 'White Noise Benefits & Safety' },
        { duration: '6 min read', title: 'Hip-Healthy Swaddling Techniques' },
        {
          duration: '5 min read',
          title: 'Sleep Props & Positive Associations',
        },
        { duration: '6 min read', title: 'Traveling with Baby Sleep Guide' },
      ],
    },
    {
      ...
      icon: Heart,
      topics: [
        { duration: '4 min read', title: 'Temperature Taking Methods by Age' },
        {
          duration: '8 min read',
          title: 'When to Call Doctor (AAP Fever Guidelines)',
        },
        { duration: '10 min read', title: 'Baby CPR & Choking Rescue (AHA)' },
        {
          duration: '7 min read',
          title: 'Common Illnesses (RSV, Croup, Ear Infections)',
        },
        { duration: '6 min read', title: 'CDC Vaccination Schedule' },
        { duration: '5 min read', title: 'Medication Dosing by Weight' },
        { duration: '4 min read', title: 'Diaper Rash Treatment Guide' },
        { duration: '5 min read', title: 'Jaundice Monitoring & Treatment' },
        { duration: '4 min read', title: 'Cradle Cap Care' },
        { duration: '5 min read', title: 'Thrush Recognition & Treatment' },
        { duration: '6 min read', title: 'Reflux vs GERD' },
        {
          duration: '5 min read',
          title: 'Teething Timeline & Pain Management',
        },
        { duration: '3 min read', title: 'Safe Nail Care Techniques' },
        { duration: '5 min read', title: 'Sun Protection (AAP Guidelines)' },
        {
          duration: '7 min read',
          title: 'Childproofing by Developmental Stage',
        },
      ],
    },
    {
      ...
      icon: TrendingUp,
      topics: [
        { duration: '5 min read', title: 'Tummy Time Progression Timeline' },
        { duration: '6 min read', title: 'Motor Skills Without Containers' },
        {
          duration: '7 min read',
          title: 'Language Development & Read-Aloud Benefits',
        },
        { duration: '6 min read', title: 'Attachment Theory & Temperament' },
        { duration: '5 min read', title: 'Visual Development Timeline' },
        { duration: '4 min read', title: 'Hearing Milestones' },
        { duration: '6 min read', title: 'Hand-Eye Coordination Progression' },
        {
          duration: '5 min read',
          title: 'Separation Anxiety (Normal Development)',
        },
        {
          duration: '5 min read',
          title: 'Stranger Anxiety & Cultural Differences',
        },
        { duration: '6 min read', title: 'Play Development Stages' },
      ],
    },
  ];
        ...
        <div className="space-y-4">
          <Card className="p-4 bg-primary/5 border-primary/20">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-sm font-medium mb-1">Recommended Reading</p>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  {journeyStage === 'ttc' &&
