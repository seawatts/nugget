---
title: 'Quickstart'
description: 'Get started with Nugget in under 5 minutes'
---
...
<Steps>
  <Step title="Installation">
    Install Nugget using your preferred package manager:
    ```bash
    # Using Homebrew
    brew install nugget
  ...
  <Step title="Initialize Project">
    ...
    - Create an `nugget.config.yaml` file
  ...
  <Step title="Start Your Webhook">
    ...
    nugget listen --client-id your-name
  ...
  <Step title="Configure Your Webhook Provider">
    Set up your webhook provider with the provided Nugget URL:
    ```bash
...
### Basic Configuration
Create an `nugget.config.yaml` file in your project root:
...
<CardGroup>
  <Card
    ...
    href="/team-setup"
  >
    Learn how to configure Nugget for your entire team
  </Card>
  <Card
    title="Dashboard"
    icon="gauge"
  ...
  <Card
    ...
    href="/security"
  >
    Learn about Nugget's security features and best practices
  </Card>
</CardGroup>
