---
title: 'Contributing'
description: 'Contribute to Nugget and run it locally'
---
...
First, clone the Nugget repository and install dependencies:
...
```bash
npm run build --workspace=@nugget/cli
```
...
<CardGroup>
  <Card
    ...
    href="/architecture"
  >
    Learn about Nugget's internal architecture
  </Card>
  <Card
    title="API Reference"
    icon="code"
