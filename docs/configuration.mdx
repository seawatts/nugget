---
title: 'Configuration'
description: 'Configure Nugget for your development environment'
---

## Configuration File

The `nugget.config.yaml` file is the primary way to configure Nugget. It supports the following options:
...
- [GitHub Issues](https://github.com/nugget-sh/nugget/issues)
