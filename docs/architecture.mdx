---
title: 'Architecture'
# description: 'Understanding Nugget\'s system design and data flow'
---

## System Overview

Nugget consists of several key components working together to provide seamless webhook development:

<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <img src="/images/arch.png" alt="Nugget Architecture" />
</div>
...
<Steps>
  <Step title="Webhook Reception">
    - Provider sends webhook to `https://nugget.baby/t_123?e=ENDPOINT`
